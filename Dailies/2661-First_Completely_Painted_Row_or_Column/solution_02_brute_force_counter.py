...
# Time Complexity:
    # O(k) for creation of position map, O(k) for checking and incrementing counters -> O(2k) overall

# Space Complexity:
    # Here we have O(k) for creation of hashmap with additional O(n + m) for the row and column counts
